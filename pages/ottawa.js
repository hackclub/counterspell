...
import Guilds from "../components/Ottawa/Guilds";
...
import Footer from "../components/Ottawa/Footer";
  ...
  return (
    <>
      <Head>
        ...
        <title>Counterspell Ottawa</title>
      </Head>
      <div>
        <div
        ...
        <div className="relative">
          ...
          <div className="flex flex-col justify-center py-12 text-center faq retro bg-darker">
            <div className="m-6">
