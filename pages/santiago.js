...
Make a copy of the example components (components/Santiago) and rename it for your city.
...
// TODO: Change `Santiago` to the name of your city. This should match the folder you copied!
import Hero from "../components/Santiago/Hero";
import About from "../components/Santiago/About";
import Guilds from "../components/Santiago/Guilds";
import Steps from "../components/Santiago/Steps";
import Locations from "../components/Santiago/Locations";
import Faq from "../components/Santiago/Faq";
import Footer from "../components/Santiago/Footer";

// TODO: Change `Santiago` to the name of your city
  ...
  return (
    <>
      <Head>
        ...
        <title>Counterspell Santiago</title>
      </Head>
      <div>
        <div
