...
import Hero from "../components/Minneapolis/Hero";
import About from "../components/Minneapolis/About";
import Guilds from "../components/Minneapolis/Guilds";
import Steps from "../components/Minneapolis/Steps";
...
export default function Minneapolis() {
  ...
  return (
    <>
      <Head>
        <title>Counterspell Minneapolis</title>
      </Head>
      <div>
        <div
